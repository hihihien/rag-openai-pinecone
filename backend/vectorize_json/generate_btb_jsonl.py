...
# ---------- Step 1: Load BTB Modules ----------
JSON_PATH = Path("backend/data/MHB_Alle_Studiengaenge/json/Studiengang_BTB_2025.json")
...
for m in modules:
    try:
        ...
        mod_id = f"BTB__{mod_num.replace(' ', '_')}"
...
output_path = Path("backend/data/processed_json/BTB_modules_for_upload.jsonl")
