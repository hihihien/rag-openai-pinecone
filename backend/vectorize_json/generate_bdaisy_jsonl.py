...
# ---------- Step 1: Load BDAISY Modules ----------
JSON_PATH = Path("backend/data/MHB_Alle_Studiengaenge/json/Studiengang_BDAISY_2021.json")
...
for m in modules:
    ...
    try:
        ...
        formatted_records.append({
            "id": f"BDAISY__{mod_num.replace(' ', '_')}",
            "text": text,
            "metadata": metadata
        })
...
output_path = Path("backend/data/processed_json/BDAISY_modules_for_upload.jsonl")
