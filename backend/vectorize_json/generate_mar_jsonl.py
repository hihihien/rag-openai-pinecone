...
# ---------- Step 1: Load MAR Modules ----------
JSON_PATH = Path("backend/data/MHB_Alle_Studiengaenge/json/Studiengang_MAR_2027.json")
...
output_path = Path("backend/data/processed_json/MAR_modules_for_upload.jsonl")
